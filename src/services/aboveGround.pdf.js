                ...
                <tr>
                    ...
                    <td class="content-cell">
                        ...
                        <div class="field-row" style="margin-top: 15px;">
                            <div style="flex-grow: 2;">
                                <div class="line">
                                    ${fireMarshalOrAHJSign ? `<img src="${fireMarshalOrAHJSign}" style="height: 170px; width: 170px; margin-top: 5px;">` : ''}
                                </div>
                        ...
                        <div class="field-row" style="margin-top: 25px;">
                            <div style="flex-grow: 2;">
                                <div class="line">
                                    ${sprinklerContractorSign ? `<img src="${sprinklerContractorSign}" style="height: 170px; width: 170px; margin-top: 5px;">` : ''}
                                </div>
